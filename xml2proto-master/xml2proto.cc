// Compile with:
//   clang++-14 -Wall -lprotobuf -lprotoc -lxml2 -I/usr/include/libxml2 -lpthread ./xml2proto.cc
// PKG_CONFIG_PATH=/home/nosat/Public/protobuf/lib/pkgconfig;
// LD_LIBRARY_PATH=/home/hosat/Public/protobuf/lib 
// clang++-14 -v -Wall `pkg-config --cflags --libs --static protobuf` `pkg-config --cflags --libs protoc` -static -lxml2 -I/usr/include/libxml2 -I./protobuf/include/ -lpthread ./xml2proto-master/xml2proto.cc
  ...
  while (true) {
    ...
    switch (node_type) {
      case XML_NODE_ELEMENT: {
        ...
        const Reflection* target_reflection =
